 ...
 */
// class_precision_parameter(a_ini_over_a_today_default,double,1.e-14)//MANUEL: ORIGINAL
class_precision_parameter(a_ini_over_a_today_default,double,1.e-20)// MANUEL: NEW
/**
 ...
 */
class_precision_parameter(recfast_z_initial,double,1.0e4)//MANUEL: ORIGINAL
// class_precision_parameter(recfast_z_initial,double,5.e4)//MANUEL: NEW
/**
 * Number of recfast integration steps, e.g. if this is 1.10^4 and the previous one is 10^4, the step will be Delta z = 0.5
 */
class_precision_parameter(recfast_Nz0,int,20000)//MANUEL: ORIGINAL
// class_precision_parameter(recfast_Nz0,int,100000)//MANUEL: NEW
/**
...
//MANUEL
class_precision_parameter(refine, int, 100) /**< refining steps for integration */

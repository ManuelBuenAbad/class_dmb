...
//MANUEL
  short has_source_delta_chi;  /**< do we need source for delta of interacting dark matter? */
//MANUEL
...
//MANUEL
  short has_source_theta_chi;  /**< do we need source for theta of interacting dark matter? */
//MANUEL
...
//MANUEL
  int index_tp_delta_chi; /**< index value for delta of interacting dark matter */
//MANUEL
...
//MANUEL
  int index_tp_theta_chi;  /**< index value for theta of interacting dark matter */
//MANUEL
...
//MANUEL
  ...
  short is_thetab_blind;  // a flag that allows me to ignore the effects of theta_chi on theta_b
  short tight_chib;       // a flag that allows me to switch the initial conditions of theta_chi
//MANUEL

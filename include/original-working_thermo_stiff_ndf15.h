...
extern "C" {
  ...
  int thinitialize_jacobian(struct jacobian *jac, int neq, ErrorMsg error_message);
  int thuninitialize_jacobian(struct jacobian *jac);
  int thinitialize_numjac_workspace(struct numjac_workspace * nj_ws,int neq, ErrorMsg error_message);
  int thuninitialize_numjac_workspace(struct numjac_workspace * nj_ws);
  int thcalc_C(struct jacobian *jac);
  ...
  int thnew_linearisation(struct jacobian *jac,double hinvGak,int neq, ErrorMsg error_message);
